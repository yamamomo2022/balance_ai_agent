...
void main() {
  group('AppTheme Tests', () {
    test('AppTheme has all required color constants', () {
      ...
      expect(AppTheme.secondaryColor,
          equals(const Color.fromARGB(255, 98, 185, 195)));

      // Test gradient colors
      expect(AppTheme.gradientStart,
          equals(const Color.fromARGB(255, 114, 219, 184)));
      expect(AppTheme.gradientEnd,
          equals(const Color.fromARGB(255, 87, 151, 199)));
    ...
    test('AppTheme gradients are properly defined', () {
      ...
      expect(AppTheme.loginBackgroundGradient.colors,
          contains(AppTheme.loginGradientStart));
      expect(AppTheme.loginBackgroundGradient.colors,
          contains(AppTheme.loginGradientEnd));
      expect(
          AppTheme.loginBackgroundGradient.begin, equals(Alignment.topCenter));
      expect(
          AppTheme.loginBackgroundGradient.end, equals(Alignment.bottomCenter));
    });
