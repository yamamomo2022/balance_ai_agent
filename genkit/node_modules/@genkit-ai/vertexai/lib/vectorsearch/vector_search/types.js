...
const RestrictionSchema = import_genkit.z.object({
  ...
  allowList: import_genkit.z.array(import_genkit.z.string()).optional(),
  denyList: import_genkit.z.array(import_genkit.z.string()).optional()
});
