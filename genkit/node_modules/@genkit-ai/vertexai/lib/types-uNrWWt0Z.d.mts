...
import { ModelReference, MessageData, ModelInfo, CandidateData, GenerateRequest, ModelAction } from 'genkit/model';
 ...
 */
declare function defineGeminiKnownModel(ai: Genkit, name: string, vertexClientFactory: (request: GenerateRequest<typeof GeminiConfigSchema>) => VertexAI, options: PluginOptions): ModelAction;
/**
 * Define a Vertex AI Gemini model.
 */
declare function defineGeminiModel(ai: Genkit, modelName: string, version: string, modelInfo: ModelInfo | undefined, vertexClientFactory: (request: GenerateRequest<typeof GeminiConfigSchema>) => VertexAI, options: PluginOptions): ModelAction;
...
export { type CommonPluginOptions as C, type GeminiConfig as G, type PluginOptions as P, SUPPORTED_V1_MODELS as S, gemini10Pro as a, gemini15Flash as b, gemini15Pro as c, gemini20Flash001 as d, gemini20FlashLitePreview0205 as e, gemini20ProExp0205 as f, gemini as g, GeminiConfigSchema as h, type GeminiVersionString as i, GENERIC_GEMINI_MODEL as j, SUPPORTED_V15_MODELS as k, SUPPORTED_GEMINI_MODELS as l, toGeminiMessage as m, fromGeminiCandidate as n, cleanSchema as o, defineGeminiKnownModel as p, defineGeminiModel as q, toGeminiSystemInstruction as t };
