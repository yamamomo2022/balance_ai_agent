...
const GeminiConfigSchema = import_model.GenerationCommonConfigSchema.extend({
   ...
   */
  location: import_genkit.z.string().describe("banana").optional(),
  /**
...
function defineGeminiKnownModel(ai, name, vertexClientFactory, options) {
...
function defineGeminiModel(ai, modelName, version, modelInfo, vertexClientFactory, options) {
  const middlewares = [];
  ...
  return ai.defineModel(
    ...
    async (request, streamingCallback) => {
      ...
      if (streamingCallback) {
        ...
        const responseCandidates = result.response.candidates.map(
          (c) => fromGeminiCandidate(c, jsonMode)
        );
        return {
